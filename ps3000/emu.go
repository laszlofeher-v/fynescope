...
int16_t ps3000_get_unit_info(int16_t handle, int8_t *string, int16_t string_length, int16_t line) {
    int16_t reqSize = 0;
...
int16_t ps3000_get_timebase(int16_t handle, int16_t timebase, int32_t no_of_samples, int32_t *time_interval, int16_t *time_units, int16_t oversample, int32_t *max_samples) {
    (void)oversample;
    int32_t dummy_max = 0;
    int32_t time_int_ns = 0;
    PICO_STATUS status = ps2000aGetTimebase(handle, (uint32_t)timebase, no_of_samples, &time_int_ns, 0, &dummy_max, 0);
    if (status == 0) {
        if (time_interval) *time_interval = time_int_ns;
        if (time_units) *time_units = 2;
        if (max_samples) *max_samples = dummy_max;
        return 1;
    }
    return 0;
}
...
int16_t ps3000_set_trigger(int16_t handle, int16_t source, int16_t threshold, int16_t direction, int16_t delay, int16_t auto_trigger_ms) {
    return (ps2000aSetSimpleTrigger(handle, 1, (PS2000A_CHANNEL)source, threshold, (PS2000A_THRESHOLD_DIRECTION)direction, (uint32_t)delay, auto_trigger_ms) == 0) ? 1 : 0;
}
...
int16_t ps3000_run_block(int16_t handle, int32_t no_of_values, int16_t timebase, int16_t oversample, int32_t * time_indisposed_ms) {
    return ps2000aRunBlock(handle, 0, no_of_values, timebase,oversample, time_indisposed_ms, 0, NULL, NULL);
}

int16_t ps3000_run_streaming(int16_t handle, int16_t sample_interval_ms, int32_t max_samples, int16_t windowed) {
    uint32_t interval = (uint32_t)sample_interval_ms;
    return (ps2000aRunStreaming(handle, &interval, PS2000A_MS, 0, (uint32_t)max_samples, 0, 1, PS2000A_RATIO_MODE_NONE, 100000) == 0) ? 1 : 0;
}
...
int32_t ps3000_get_values(int16_t handle, int16_t *buffer_a, int16_t *buffer_b, int16_t *buffer_c, int16_t *buffer_d, int16_t *overflow, int32_t no_of_values) {
    ...
    uint32_t samples = (uint32_t)no_of_values;
    int16_t ov = 0;
...
int32_t ps3000_get_times_and_values(int16_t handle, int32_t *times, int16_t *buffer_a, int16_t *buffer_b, int16_t *buffer_c, int16_t *buffer_d, int16_t *overflow, int16_t time_units, int32_t no_of_values) {
    (void)times;
    (void)time_units;
    return ps3000_get_values(handle, buffer_a, buffer_b, buffer_c, buffer_d, overflow, no_of_values);
}
...
int16_t ps3000_get_streaming_last_values(int16_t handle, GetOverviewBuffersMaxMin getOverviewBuffersMaxMin) {
    (void)handle;
...
uint32_t ps3000_get_streaming_values(int16_t handle, double *start_time, int16_t *pbuffer_a_max, int16_t *pbuffer_a_min, int16_t *pbuffer_b_max, int16_t *pbuffer_b_min, int16_t *pbuffer_c_max, int16_t *pbuffer_c_min, int16_t *pbuffer_d_max, int16_t *pbuffer_d_min, int16_t *overflow, uint32_t *triggerAt, int16_t *triggered, uint32_t no_of_values, uint32_t noOfSamplesPerAggregate) {
    (void)handle; (void)start_time; (void)pbuffer_a_max; (void)pbuffer_a_min;
    (void)pbuffer_b_max; (void)pbuffer_b_min; (void)pbuffer_c_max; (void)pbuffer_c_min;
    (void)pbuffer_d_max; (void)pbuffer_d_min; (void)overflow; (void)triggerAt;
    (void)triggered; (void)no_of_values; (void)noOfSamplesPerAggregate;
    return 0;
}
...
uint32_t ps3000_get_streaming_values_no_aggregation(int16_t handle, double *start_time, int16_t * pbuffer_a, int16_t * pbuffer_b, int16_t * pbuffer_c, int16_t * pbuffer_d, int16_t * overflow, uint32_t * triggerAt, int16_t * trigger, uint32_t no_of_values) {
    (void)handle; (void)start_time; (void)pbuffer_a; (void)pbuffer_b;
    (void)pbuffer_c; (void)pbuffer_d; (void)overflow; (void)triggerAt;
    (void)trigger; (void)no_of_values;
    return 0;
}
...
int32_t ps3000_set_siggen(int16_t handle, int16_t wave_type, int32_t start_frequency, int32_t stop_frequency, float increment, int16_t dwell_time, int16_t repeat, int16_t dual_slope) {
    (void)repeat;
    (void)dual_slope;
    return (ps2000aSetSigGenBuiltIn(handle, 0, 2000000, wave_type, (float)start_frequency, (float)stop_frequency, increment, (float)dwell_time, PS2000A_SINGLE, PS2000A_ES_OFF, 0, 0, PS2000A_SIGGEN_RISING, PS2000A_SIGGEN_NONE, 0) == 0) ? 1 : 0;
}
