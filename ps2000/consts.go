...
const (
	MaxChannels       = C.PS2000_MAX_CHANNELS
	ChannelInfoRanges = 12 // manually set, since ps2000 doesn't have PS2000_CI_RANGES
)
...
const (
	Range_10mv  RangeEnum = C.PS2000_10MV
	Range_20mv  RangeEnum = C.PS2000_20MV
	Range_50mv  RangeEnum = C.PS2000_50MV
	Range_100mv RangeEnum = C.PS2000_100MV
	Range_200mv RangeEnum = C.PS2000_200MV
	Range_500mv RangeEnum = C.PS2000_500MV
	Range_1v    RangeEnum = C.PS2000_1V
	Range_2v    RangeEnum = C.PS2000_2V
	Range_5v    RangeEnum = C.PS2000_5V
	Range_10v   RangeEnum = C.PS2000_10V
	Range_20v   RangeEnum = C.PS2000_20V
	Range_50v   RangeEnum = C.PS2000_50V
)
...
const (
	ChA ChannelId = C.PS2000_CHANNEL_A
	ChB ChannelId = C.PS2000_CHANNEL_B
	ChC ChannelId = C.PS2000_CHANNEL_C
	ChD ChannelId = C.PS2000_CHANNEL_D
)
...
const (
	TriggerAbove           ThresholdDirection = C.PS2000_ABOVE
	TriggerBelow           ThresholdDirection = C.PS2000_BELOW
	TriggerRising          ThresholdDirection = C.PS2000_ADV_RISING
	TriggerFalling         ThresholdDirection = C.PS2000_ADV_FALLING
	TriggerRisingOrFalling ThresholdDirection = C.PS2000_RISING_OR_FALLING
	TriggerOutside         ThresholdDirection = C.PS2000_OUTSIDE
	TriggerInside          ThresholdDirection = C.PS2000_INSIDE
	TriggerEnter           ThresholdDirection = C.PS2000_ENTER
	TriggerExit            ThresholdDirection = C.PS2000_EXIT
	TriggerEnterOrExit     ThresholdDirection = C.PS2000_ENTER_OR_EXIT
	TriggerNone            ThresholdDirection = C.PS2000_ADV_NONE
)
...
const (
	TuFs TimeUnits = C.PS2000_FS
	TuPs TimeUnits = C.PS2000_PS
	TuNs TimeUnits = C.PS2000_NS
	TuUs TimeUnits = C.PS2000_US
	TuMs TimeUnits = C.PS2000_MS
	TuS  TimeUnits = C.PS2000_S
)
...
const (
	...
	CondFalse    TriggerState = C.PS2000_CONDITION_FALSE
	CondMax      TriggerState = C.PS2000_CONDITION_MAX
)
...
const (
	...
	PwTypeGreaterThan PulseWidthType = C.PS2000_PW_TYPE_GREATER_THAN
	PwTypeInRange     PulseWidthType = C.PS2000_PW_TYPE_IN_RANGE
	PwTypeOutOfRange  PulseWidthType = C.PS2000_PW_TYPE_OUT_OF_RANGE
)
...
const (
	...
	EtsSlow EtsMode = C.PS2000_ETS_SLOW
	EtsMax  EtsMode = C.PS2000_ETS_MODES_MAX
)
