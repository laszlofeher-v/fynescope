	...
	return &PsSettings{
		...
		Digital: DigitalSettings{
			...
			ChannelColors: [16]color.NRGBA{
				...
				{255, 50, 50, 255},   // ch10 – bright red
				{50, 220, 50, 255},   // ch11 – green
				{255, 180, 50, 255},  // ch12 – amber
				{220, 50, 255, 255},  // ch13 – purple
				{0, 230, 230, 255},   // ch14 – teal
				{255, 130, 230, 255}, // ch15 – lavender pink
			},
