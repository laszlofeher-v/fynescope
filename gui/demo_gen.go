...
func (scp *ScpDesc) newDemoGenPanel(cont *fyne.Container, undockable bool) (err error) {
	...
	newGenSettings = func(ch genericps.ChannelId, undockable bool) (box *fyne.Container, err error) {
		...
		RegisterWidgetHelp(show, "Generator Channel Visibility", "Shows or hides waveform parameters for this generator output channel.")
		check := widget.NewCheck("On", checked)
		check.Checked = genSettings.On

		addToTest(check, genCheckId, genTabIndex)
		RegisterWidgetHelp(check, "Generator Channel Output", "Enables or disables waveform generation for this channel.")
		...
		RegisterWidgetHelp(raiseFallTimeDisp, "Rise / Fall Time", "Sets edge transition time for pulses and square waves.")
		if err != nil {
			return
		}
		...
		RegisterWidgetHelp(noiseAmplitudeDisp, "Noise Amplitude", "Sets Gaussian noise injection level added to signal.")
		if err != nil {
			return
		}
		...
		RegisterWidgetHelp(phaseNoiseDisp, "Phase Noise", "Sets simulated phase jitter / noise on the generator clock.")
		if err != nil {
			return
		}
		...
		RegisterWidgetHelp(phaseDisp, "Generator Phase", "Sets relative phase angle shift for signal generator waveform.")
		if err != nil {
			return
		}
		...
		RegisterWidgetHelp(waveType, "Waveform Shape", "Selects generated waveform function: Sine, Square, Triangle, Ramp, DC, Noise, or Arbitrary.")
		if undockable {
			...
			RegisterWidgetHelp(undockButton, "Undock Generator Panel", "Opens the signal generator controls in an independent floating window.")
		}
		...
		RegisterWidgetHelp(freqSetAnalog, "Frequency Presets", "Quick selection presets for standard test frequencies.")
		...
		RegisterWidgetHelp(ampSetAnalog, "Amplitude Presets", "Quick selection presets for standard test amplitudes.")
		...
		RegisterWidgetHelp(frequency, "Generator Frequency", "Sets periodic waveform frequency generated by the hardware.")
		...
		RegisterWidgetHelp(dwellTime, "Sweep Dwell Time", "Sets duration to hold each frequency during sweep.")
		if err != nil {
			return
		}
		...
		RegisterWidgetHelp(startFrqDisp, "Sweep Start Frequency", "Sets lower frequency limit for generator frequency sweeps.")
		...
		RegisterWidgetHelp(stopFrqDisp, "Sweep Stop Frequency", "Sets upper frequency limit for generator frequency sweeps.")
		...
		RegisterWidgetHelp(stepFreq, "Sweep Frequency Step", "Sets frequency increment per step during frequency sweep.")
		...
		RegisterWidgetHelp(amp, "Generator Amplitude", "Sets peak-to-peak output voltage amplitude of the generated waveform.")
		...
		RegisterWidgetHelp(offset, "Generator Offset", "Sets DC bias voltage added to the generated signal output.")
		...
		RegisterWidgetHelp(awgEditorBtn, "AWG Waveform Editor", "Opens the arbitrary waveform generator editor to design and upload custom waveforms.")
		...
		RegisterWidgetHelp(sweepMenu, "Frequency Sweep Mode", "Controls frequency sweep generation: Off, Up, Down, or Up/Down.")
		...
		RegisterWidgetHelp(operationSelect, "Generator Operation Mode", "Selects operational mode: continuous waveform, burst, or modulation.")
		...
		RegisterWidgetHelp(scp.triggerCalculationModeSelect, "Trigger Calculation Mode", "Selects fine-grained or coarse trigger calculation method.")
