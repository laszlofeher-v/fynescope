...
func TestDftVChannelLabelViewer_MouseIn(t *testing.T) {
	...
	viewer := newDftVChannelLabelViewer(img, rect, 0, image.Rect(0, 0, 100, 100), scp)
...
func TestDftVChannelLabelViewer_Cursor(t *testing.T) {
	img := image.NewRGBA64(image.Rect(0, 0, 100, 100))
	rect := image.Rect(10, 10, 50, 50)
...
func TestDftVChannelLabelViewer_MouseDownUp(t *testing.T) {
	img := image.NewRGBA64(image.Rect(0, 0, 100, 100))
	rect := image.Rect(10, 10, 50, 50)
...
func TestDftVChannelLabelViewer_TypedKey(t *testing.T) {
	img := image.NewRGBA64(image.Rect(0, 0, 100, 100))
	rect := image.Rect(10, 10, 50, 50)
