...
func (scp *ScpDesc) Menu(con *genericps.Connection, cfg *settings.PsSettings, fileName string) (err error) {
	...
	scp.setRangeMargin()
	scp.ftRaster = scp.newScreenRaster(scp.ftRasterGenerator, scp.Window, false, false, false, false)
	scp.dftRaster = scp.newScreenRaster(scp.dftRasterGenerator, scp.Window, true, false, false, false)
	scp.fvRaster = scp.newScreenRaster(scp.fvRasterGenerator, scp.Window, false, true, false, false)
	scp.ffRaster = scp.newScreenRaster(scp.ffRasterGenerator, scp.Window, false, false, true, false)
