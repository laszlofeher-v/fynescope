...
func (scp *ScpDesc) newExtGenTab(undockable bool) *fyne.Container {
	...
	if undockable {
		...
		RegisterWidgetHelp(undockButton, "Undock External Generator", "Opens the external SCPI signal generator in an independent floating window.")
	}
	...
	createChannelColumn := func(chIdx int, scpiCh scpi.ChType) *fyne.Container {
		...
		RegisterWidgetHelp(onOffCheck, "Generator Output", "Enables or disables signal generator output.")
		...
		RegisterWidgetHelp(waveTypeSelect, "Waveform Shape", "Selects signal generator output shape: Sine, Square, Triangle, Ramp, DC, or Noise.")
		...
		RegisterWidgetHelp(phase, "Generator Phase", "Sets relative phase angle shift for signal generator waveform.")
		...
		RegisterWidgetHelp(impedanceOhmsWidget, "Output Impedance", "Selects generator output termination impedance: 50 ohms or 600 ohms.")
