...
import (
	...
	// The following imports load the device specific drivers and registers the
	// devices for enumeration or opening.
	// _ "fynescope/ps2000"
	_ "fynescope/ps2000a"
	// _ "fynescope/ps3000"
	// _ "fynescope/ps3000a"
...
var (
	debugOn = map[string]bool{
		...
		"control/digital.go":                      false,
		"control/ets.go":                          false,
		"control/ext_gen.go":                      false,
		"control/gen.go":                          false,
		"control/interpolation.go":                false,
		"control/scheduler.go":                    false,
		"control/scope_type.go":                   false,
		"control/scpi/mock.go":                    false,
		"control/scpi/parse.go":                   false,
		"control/scpi/scpi.go":                    false,
		"control/scpi/scpi_noscpi.go":             false,
		"control/scpi/types.go":                   false,
		"control/stream.go":                       false,
		"control/timing.go":                       false,
		"control/trigger.go":                      false,
		"demo/connection.go":                      false,
		"demo/consts.go":                          false,
		"demo/demo.go":                            false,
		"demo/params.go":                          false,
		"demo/rlc.go":                             false,
		"demo/sweep.go":                           false,
		"demo/trigger.go":                         false,
		"demo/types.go":                           false,
		"demo/waveforms.go":                       false,
		"devtools/convertinc/main.go":             false,
		"disp16/disp16.go":                        false,
		"disp16/events.go":                        false,
		"disp16/renderer.go":                      false,
		"disp7/disp7.go":                          false,
		"disp7/events.go":                         false,
		"disp7/renderer.go":                       false,
		"genericps/genericps.go":                  false,
		"genericps/open.go":                       false,
		"gui/acquisition.go":                      false,
		"gui/adv_trigger_point.go":                false,
		"gui/api.go":                              false,
		"gui/awg_editor.go":                       false,
		"gui/channels.go":                         false,
		"gui/complex_trigger.go":                  false,
		"gui/complex_trigger_point.go":            false,
		"gui/decode_div.go":                       false,
		"gui/decode_draw.go":                      false,
		"gui/demo_dig_gen.go":                     false,
		"gui/demo_functional.go":                  false,
		"gui/demo_gen.go":                         false,
		"gui/dft_channel_label.go":                false,
		"gui/dft_panel.go":                        false,
		"gui/dft_raster.go":                       false,
		"gui/dft_vchannel_label.go":               false,
		"gui/digital_port_panel.go":               false,
		"gui/digital_raster.go":                   false,
		"gui/drawers.go":                          false,
		"gui/ext_gen.go":                          false,
		"gui/ff_panel.go":                         false,
		"gui/ff_raster.go":                        false,
		"gui/filter.go":                           false,
		"gui/fixed_vbox.go":                       false,
		"gui/ft_channel_label.go":                 false,
		"gui/ft_raster.go":                        false,
		"gui/ft_vchannel_label.go":                false,
		"gui/fv_panel.go":                         false,
		"gui/fv_raster.go":                        false,
		"gui/gen.go":                              false,
		"gui/generator_settings.go":               false,
		"gui/gui.go":                              false,
		"gui/help.go":                             false,
		...
		"gui/theme.go":                            false,
		"gui/tight_hbox.go":                       false,
		"gui/time_div.go":                         false,
		"gui/time_zoom.go":                        false,
		"gui/trigger_point.go":                    false,
		"gui/virtual_channel.go":                  false,
		"gui/virtual_channel_dialog.go":           false,
		"gui/voice.go":                            false,
		"gui/window_dropout_trigger_point.go":     false,
		"gui/window_mouse.go":                     false,
		"gui/window_pulse_width_trigger_point.go": false,
		"gui/window_trigger_point.go":             false,
		"main.go":                                 false,
		...
		"ps2000a/sim_c.go":                        false,
		"ps2000a/sim_device.go":                   false,
		"ps2000a/sim_noscope.go":                  false,
		"ps2000a/sim_params.go":                   false,
		"ps2000a/sim_sweep.go":                    false,
		"ps2000a/sim_waveforms.go":                false,
		"ps2000a/sim_wrappers.go":                 false,
		"ps2000a/types.go":                        false,
		"ps3000/c.go":                             false,
		"ps3000/callbacks.go":                     false,
		"ps3000/connection.go":                    false,
		"ps3000/consts.go":                        false,
		"ps3000/emu.go":                           false,
		"ps3000/no_scope.go":                      false,
		"ps3000/types.go":                         false,
		"ps3000a/c.go":                            false,
		"ps3000a/callbacks.go":                    false,
		"ps3000a/connection.go":                   false,
		"ps3000a/const.go":                        false,
		"ps3000a/emu.go":                          false,
		"ps3000a/no_emu.go":                       false,
		"ps3000a/no_scope.go":                     false,
		"ps3000a/types.go":                        false,
		"ps4000/c.go":                             false,
		"ps4000/callbacks.go":                     false,
		"ps4000/connection.go":                    false,
		"ps4000/const.go":                         false,
		"ps4000/emu.go":                           false,
		"ps4000/no_scope.go":                      false,
		"ps4000/types.go":                         false,
		"ps4000a/c.go":                            false,
		"ps4000a/callbacks.go":                    false,
		"ps4000a/connection.go":                   false,
		"ps4000a/const.go":                        false,
		"ps4000a/emu.go":                          false,
		"ps4000a/no_scope.go":                     false,
		"ps4000a/types.go":                        false,
		"ps5000/c.go":                             false,
		"ps5000/callbacks.go":                     false,
		"ps5000/connection.go":                    false,
		"ps5000/const.go":                         false,
		"ps5000/emu.go":                           false,
		"ps5000/no_scope.go":                      false,
		"ps5000/types.go":                         false,
		"ps5000a/c.go":                            false,
		"ps5000a/callbacks.go":                    false,
		"ps5000a/connection.go":                   false,
		"ps5000a/const.go":                        false,
		"ps5000a/emu.go":                          false,
		"ps5000a/no_scope.go":                     false,
		"ps5000a/types.go":                        false,
		"ps6000/c.go":                             false,
		"ps6000/callbacks.go":                     false,
		"ps6000/connection.go":                    false,
		"ps6000/const.go":                         false,
		"ps6000/emu.go":                           false,
		"ps6000/no_scope.go":                      false,
		"ps6000/types.go":                         false,
		"ps6000a/c.go":                            false,
		"ps6000a/callbacks.go":                    false,
		"ps6000a/connection.go":                   false,
		"ps6000a/const.go":                        false,
		"ps6000a/emu.go":                          false,
		"ps6000a/no_scope.go":                     false,
		"ps6000a/types.go":                        false,
		"psc/ps_consts.go":                        false,
		"selectscroll/selectscroll.go":            false,
		"settings/consts.go":                      false,
		"settings/settings.go":                    false,
		"sim_flag_noscope.go":                     false,
		"sim_flag_scope.go":                       false,
		"sliderscroll/slider_scroll.go":           false,
		"tastybutton/tasty_button.go":             false,
		"web/controller.go":                       false,
		"web/web_disabled.go":                     false,
		"web/web_enabled.go":                      false,
	}
)
