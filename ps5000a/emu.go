...
/*
#cgo linux CFLAGS: -I/opt/picoscope/include/libps5000a
...
PICO_STATUS ps5000aOpenUnit(int16_t *handle, int8_t *serial, PS5000A_DEVICE_RESOLUTION resolution) { return ps2000aOpenUnit(handle, serial); }
PICO_STATUS ps5000aOpenUnitAsync(int16_t *status, int8_t *serial, PS5000A_DEVICE_RESOLUTION resolution) { return ps2000aOpenUnitAsync(status, serial); }
PICO_STATUS ps5000aOpenUnitProgress(int16_t *handle, int16_t *progressPercent, int16_t *complete) { return ps2000aOpenUnitProgress(handle, progressPercent, complete); }
PICO_STATUS ps5000aCloseUnit(int16_t handle) { return ps2000aCloseUnit(handle); }
PICO_STATUS ps5000aGetUnitInfo(int16_t handle, int8_t *string, int16_t stringLength, int16_t *requiredSize, PICO_INFO info) {
    ...
    if (status == 0 && string != 0 && stringLength > 0) {
        if (info == 3) strcpy((char *)string, "54AEM");
    }
    return status;
}
PICO_STATUS ps5000aFlashLed(int16_t handle, int16_t start) { return ps2000aFlashLed(handle, start); }
PICO_STATUS ps5000aGetValuesAsync(int16_t handle, uint32_t startIndex, uint32_t noOfSamples, uint32_t downSampleRatio, PS5000A_RATIO_MODE downSampleRatioMode, uint32_t segmentIndex, void *lpDataReady, void *pParameter) { return ps2000aGetValuesAsync(handle, startIndex, noOfSamples, downSampleRatio, (uint32_t)downSampleRatioMode, segmentIndex, lpDataReady, pParameter); }
PICO_STATUS ps5000aGetValues(int16_t handle, uint32_t startIndex, uint32_t *noOfSamples, uint32_t downSampleRatio, PS5000A_RATIO_MODE downSampleRatioMode, uint32_t segmentIndex, int16_t *overflow) { return ps2000aGetValues(handle, startIndex, noOfSamples, downSampleRatio, (uint32_t)downSampleRatioMode, segmentIndex, overflow); }
PICO_STATUS ps5000aGetValuesBulk(int16_t handle, uint32_t *noOfSamples, uint32_t fromSegmentIndex, uint32_t toSegmentIndex, uint32_t downSampleRatio, PS5000A_RATIO_MODE downSampleRatioMode, int16_t *overflow) { return ps2000aGetValuesBulk(handle, noOfSamples, fromSegmentIndex, toSegmentIndex, downSampleRatio, (uint32_t)downSampleRatioMode, overflow); }
PICO_STATUS ps5000aGetValuesOverlapped(int16_t handle, uint32_t startIndex, uint32_t *noOfSamples, uint32_t downSampleRatio, PS5000A_RATIO_MODE downSampleRatioMode, uint32_t segmentIndex, int16_t *overflow) { return ps2000aGetValuesOverlapped(handle, startIndex, noOfSamples, downSampleRatio, (uint32_t)downSampleRatioMode, segmentIndex, overflow); }
PICO_STATUS ps5000aGetValuesOverlappedBulk(int16_t handle, uint32_t startIndex, uint32_t *noOfSamples, uint32_t downSampleRatio, PS5000A_RATIO_MODE downSampleRatioMode, uint32_t fromSegmentIndex, uint32_t toSegmentIndex, int16_t *overflow) { return ps2000aGetValuesOverlappedBulk(handle, startIndex, noOfSamples, downSampleRatio, (uint32_t)downSampleRatioMode, fromSegmentIndex, toSegmentIndex, overflow); }
PICO_STATUS ps5000aGetAnalogueOffset(int16_t handle, PS5000A_RANGE range, PS5000A_COUPLING coupling, float *maximumOffset, float *minimumOffset) { return ps2000aGetAnalogueOffset(handle, (uint32_t)range, (uint32_t)coupling, maximumOffset, minimumOffset); }
PICO_STATUS ps5000aGetChannelInformation(int16_t handle, PS5000A_CHANNEL_INFO info, int32_t probe, int32_t *ranges, int32_t *length, int32_t channels) { return ps2000aGetChannelInformation(handle, (uint32_t)info, probe, ranges, length, channels); }
PICO_STATUS ps5000aGetMaxDownSampleRatio(int16_t handle, uint32_t noOfUnaggregatedSamples, uint32_t *maxDownSampleRatio, PS5000A_RATIO_MODE downSampleRatioMode, uint32_t segmentIndex) { return ps2000aGetMaxDownSampleRatio(handle, noOfUnaggregatedSamples, maxDownSampleRatio, (uint32_t)downSampleRatioMode, segmentIndex); }
PICO_STATUS ps5000aGetMaxSegments(int16_t handle, uint32_t *maxSegments) { return ps2000aGetMaxSegments(handle, maxSegments); }
PICO_STATUS ps5000aGetNoOfCaptures(int16_t handle, uint32_t *nCaptures) { return ps2000aGetNoOfCaptures(handle, nCaptures); }
PICO_STATUS ps5000aGetNoOfProcessedCaptures(int16_t handle, uint32_t *nProcessedCaptures) { return ps2000aGetNoOfProcessedCaptures(handle, nProcessedCaptures); }
PICO_STATUS ps5000aGetStreamingLatestValues(int16_t handle, ps5000aStreamingReady lpPs5000aReady, void *pParameter) { return ps2000aGetStreamingLatestValues(handle, (void*)lpPs5000aReady, pParameter); }
PICO_STATUS ps5000aGetTimebase(int16_t handle, uint32_t timebase, int32_t noSamples, int32_t *timeIntervalNanoseconds, int32_t *maxSamples, uint32_t segmentIndex) { return ps2000aGetTimebase(handle, timebase, noSamples, timeIntervalNanoseconds, 0, maxSamples, segmentIndex); }
PICO_STATUS ps5000aGetTimebase2(int16_t handle, uint32_t timebase, int32_t noSamples, float *timeIntervalNanoseconds, int32_t *maxSamples, uint32_t segmentIndex) { return ps2000aGetTimebase2(handle, timebase, noSamples, timeIntervalNanoseconds, 0, maxSamples, segmentIndex); }
PICO_STATUS ps5000aSetChannel(int16_t handle, PS5000A_CHANNEL channel, int16_t enabled, PS5000A_COUPLING type, PS5000A_RANGE range, float analogOffset) { return ps2000aSetChannel(handle, (uint32_t)channel, enabled, (uint32_t)type, (uint32_t)range, analogOffset); }
PICO_STATUS ps5000aMaximumValue(int16_t handle, int16_t *value) { return ps2000aMaximumValue(handle, value); }
PICO_STATUS ps5000aMinimumValue(int16_t handle, int16_t *value) { return ps2000aMinimumValue(handle, value); }
PICO_STATUS ps5000aSetSimpleTrigger(int16_t handle, int16_t enable, PS5000A_CHANNEL source, int16_t threshold, PS5000A_THRESHOLD_DIRECTION direction, uint32_t delay, int16_t autoTrigger_ms) { return ps2000aSetSimpleTrigger(handle, enable, (uint32_t)source, threshold, (uint32_t)direction, delay, autoTrigger_ms); }
PICO_STATUS ps5000aSetDataBuffer(int16_t handle, PS5000A_CHANNEL channel, int16_t *buffer, int32_t bufferLth, uint32_t segmentIndex, PS5000A_RATIO_MODE mode) { return ps2000aSetDataBuffer(handle, (uint32_t)channel, buffer, bufferLth, segmentIndex, (uint32_t)mode); }
PICO_STATUS ps5000aSetDataBuffers(int16_t handle, PS5000A_CHANNEL channel, int16_t *bufferMax, int16_t *bufferMin, int32_t bufferLth, uint32_t segmentIndex, PS5000A_RATIO_MODE mode) { return ps2000aSetDataBuffers(handle, (uint32_t)channel, bufferMax, bufferMin, bufferLth, segmentIndex, (uint32_t)mode); }
PICO_STATUS ps5000aSetEtsTimeBuffer(int16_t handle, int64_t *buffer, int32_t bufferLth) { return ps2000aSetEtsTimeBuffer(handle, buffer, bufferLth); }
PICO_STATUS ps5000aSetEtsTimeBuffers(int16_t handle, uint32_t *timeUpper, uint32_t *timeLower, int32_t bufferLth) { return ps2000aSetEtsTimeBuffers(handle, timeUpper, timeLower, bufferLth); }
...
PICO_STATUS ps5000aSetSigGenBuiltIn(int16_t handle, int32_t offsetVoltage, uint32_t pkToPk, PS5000A_WAVE_TYPE waveType, float startFrequency, float stopFrequency, float increment, float dwellTime, PS5000A_SWEEP_TYPE sweepType, PS5000A_EXTRA_OPERATIONS operation, uint32_t shots, uint32_t sweeps, PS5000A_SIGGEN_TRIG_TYPE triggerType, PS5000A_SIGGEN_TRIG_SOURCE triggerSource, int16_t extInThreshold) { return ps2000aSetSigGenBuiltIn(handle, offsetVoltage, pkToPk, (int16_t)waveType, startFrequency, stopFrequency, increment, dwellTime, (uint32_t)sweepType, (uint32_t)operation, shots, sweeps, (uint32_t)triggerType, (uint32_t)triggerSource, extInThreshold); }
PICO_STATUS ps5000aSetSigGenBuiltInV2(int16_t handle, int32_t offsetVoltage, uint32_t pkToPk, PS5000A_WAVE_TYPE waveType, double startFrequency, double stopFrequency, double increment, double dwellTime, PS5000A_SWEEP_TYPE sweepType, PS5000A_EXTRA_OPERATIONS operation, uint32_t shots, uint32_t sweeps, PS5000A_SIGGEN_TRIG_TYPE triggerType, PS5000A_SIGGEN_TRIG_SOURCE triggerSource, int16_t extInThreshold) { return ps2000aSetSigGenBuiltInV2(handle, offsetVoltage, pkToPk, (int16_t)waveType, startFrequency, stopFrequency, increment, dwellTime, (uint32_t)sweepType, (uint32_t)operation, shots, sweeps, (uint32_t)triggerType, (uint32_t)triggerSource, extInThreshold); }
PICO_STATUS ps5000aSigGenFrequencyToPhase(int16_t handle, double frequency, PS5000A_INDEX_MODE indexMode, uint32_t bufferLength, uint32_t *phase) { return ps2000aSigGenFrequencyToPhase(handle, frequency, (uint32_t)indexMode, bufferLength, phase); }
PICO_STATUS ps5000aSetNoOfCaptures(int16_t handle, uint32_t nCaptures) { return ps2000aSetNoOfCaptures(handle, nCaptures); }
PICO_STATUS ps5000aGetTriggerTimeOffset(int16_t handle, uint32_t *timeUpper, uint32_t *timeLower, PS5000A_TIME_UNITS *timeUnits, uint32_t segmentIndex) { return ps2000aGetTriggerTimeOffset(handle, timeUpper, timeLower, (void*)timeUnits, segmentIndex); }
PICO_STATUS ps5000aGetTriggerTimeOffset64(int16_t handle, int64_t *time, PS5000A_TIME_UNITS *timeUnits, uint32_t segmentIndex) { return ps2000aGetTriggerTimeOffset64(handle, time, (void*)timeUnits, segmentIndex); }
