...
func getValues(m *genericps.GetValuesMsg) {
	...
	numOfSamples, overflow, err = ps6000GetValues(m.Handle(), uint32(m.StartIndex),
...
func setChannel(m *genericps.SetChannelMsg) {
	var err error
	err = ps6000SetChannel(m.Handle(), ChannelId(m.Channel),
...
func flashLed(m *genericps.FlashLedMsg) {
	err := ps6000FlashLed(m.Handle(), m.Start)
...
func getUnitInfo(m *genericps.GetUnitInfoMsg) {
	...
	s, err = ps6000GetUnitInfo(m.Handle(), PicoInfo(m.Info))
	if err != nil {
...
func getValuesAsync(m *genericps.GetValuesAsyncMsg) {
	var err error
	err = ps6000GetValuesAsync(m.Handle(), uint32(m.StartIndex),
...
func getValuesBulk(m *genericps.GetValuesBulkMsg) {
	...
	numOfSamples, err = ps6000GetValuesBulk(m.Handle(), uint32(m.ReqNumOfSamples),
		uint32(m.FromSegmentIndex), uint32(m.ToSegmentIndex),
...
func getValuesOverlapped(m *genericps.GetValuesOverlappedMsg) {
	...
	numOfSamples, err = ps6000GetValuesOverlapped(m.Handle(), m.StartIndex, m.ReqNumOfSamples,
...
func getValuesOverlappedBulk(m *genericps.GetValuesOverlappedBulkMsg) {
	...
	numOfSamples, err = ps6000GetValuesOverlappedBulk(m.Handle(), m.StartIndex, m.ReqNumOfSamples,
...
func getAnalogueOffsetMsg(m *genericps.GetAnalogueOffsetMsg) {
	...
	maximumVoltage, minimumVoltage, err = ps6000GetAnalogueOffset(m.Handle(), m.VoltageRange, Coupling(m.Coupling))
...
func getChannelInformation(m *genericps.GetChannelInformationMsg) {
	...
	lengthOfRanges, err = ps6000GetChannelInformation(m.Handle(), m.Info, m.Probe, m.Ranges, ChannelId(m.Channel))
...
func getMaxDownSampleRatio(m *genericps.GetMaxDownSampleRatioMsg) {
	...
	maxDownSampleRatio, err = ps6000GetMaxDownSampleRatio(m.Handle(), m.NumOfUnaggregatedSamples, RatioMode(m.DownSampleRatioMode), m.SegmentIndex)
...
func getMaxSegments(m *genericps.GetMaxSegmentsMsg) {
	maxSegments, err := ps6000GetMaxSegments(m.Handle())
...
func getNumberOfCaptures(m *genericps.GetNumOfCapturesMsg) {
	numOfCaptures, err := ps6000GetNumOfCaptures(m.Handle())
...
func getNumberOfProcessedCaptures(m *genericps.GetNumOfProcessedCapturesMsg) {
	numOfCaptures, err := ps6000GetNumOfProcessedCaptures(m.Handle())
...
func getStreamingLatestValues(m *genericps.GetStreamingLatestValuesMsg) {
	...
	err = ps6000GetStreamingLatestValues(m.Handle(), StreamingReady(m.LpStreamingReadyGoPar), m.Param)
...
func getTimebase(m *genericps.GetTimebaseMsg) {
	timeIntervalNanoseconds, maxSamples, err := ps6000GetTimebase(m.Handle(),
		m.TimeBase, uint32(m.NumOfSamples), m.OverSample, m.SegmentIndex)
...
func maximumValue(m *genericps.MaximumValueMsg) {
	value, err := ps6000MaximumValue(m.Handle())
...
func minimumValue(m *genericps.MinimumValueMsg) {
	value, err := ps6000MinimumValue(m.Handle())
...
func setSimpleTrigger(m *genericps.SetSimpleTriggerMsg) {
	...
	err = ps6000SetSimpleTrigger(m.Handle(), m.Enable, ChannelId(m.Source),
...
func setDataBuffers(m *genericps.SetDataBuffersMsg) {
	...
	err = ps6000SetDataBuffers(m.Handle(), ChannelId(m.Ch), m.BufferMax, m.BufferMin, m.SegmentIndex, RatioMode(m.Mode))
...
func setUnscaledDataBuffers(m *genericps.SetUnscaledDataBuffersMsg) {
	...
	err = ps6000SetUnscaledDataBuffers(m.Handle(), ChannelId(m.Ch), m.BufferMax, m.BufferMin, m.SegmentIndex, RatioMode(m.Mode))
...
func setEtsTimeBuffer(m *genericps.SetEtsTimeBufferMsg) {
	err := ps6000SetEtsTimeBuffer(m.Handle(), m.Buffer)
...
func setEtsTimeBuffers(m *genericps.SetEtsTimeBuffersMsg) {
	err := ps6000SetEtsTimeBuffers(m.Handle(), m.TimeUpper, m.TimeLower)
	response := m.Rsp().(*genericps.SetEtsTimeBufferRsp)
	response.SetStatus(err)
	m.RspCh() <- struct{}{}
}
func setEts(m *genericps.SetEtsMsg) {
	...
	sampleTimePicoseconds, err = ps6000SetEts(m.Handle(), EtsMode(m.Mode), m.EtsCycles, m.EtsInterleave)
...
func runStreaming(m *genericps.RunStreamingMsg) {
	...
	sampleInterval, err = ps6000RunStreaming(m.Handle(), m.ReqSampleInterval, TimeUnits(m.SampleIntervalTimeUnits), m.MaxPostTriggerSamples,
...
func setTriggerChannelProperties(m *genericps.SetTriggerChannelPropertiesMsg) {
	...
	err = ps6000SetTriggerChannelProperties(m.Handle(), tcp, m.AuxOutputEnable, m.AutoTriggerMs)
...
func setTriggerChannelConditions(m *genericps.SetTriggerChannelConditionsMsg) {
	...
	err = ps6000SetTriggerChannelConditions(m.Handle(), tc)
...
func setTriggerChannelDirections(m *genericps.SetTriggerChannelDirectionsMsg) {
	...
	err = ps6000SetTriggerChannelDirections(m.Handle(), ThresholdDirection(m.ChannelA),
...
func setTriggerDelay(m *genericps.SetTriggerDelayMsg) {
	err := ps6000SetTriggerDelay(m.Handle(), m.Delay)
...
func setPulseWidthQualifier(m *genericps.SetPulseWidthQualifierMsg) {
	...
	err = ps6000SetPulseWidthQualifier(m.Handle(), c, ThresholdDirection(m.Direction), m.Lower, m.Upper, PulseWidthType(m.PwType))
...
func setTriggerDigitalPortProperties(m *genericps.SetTriggerDigitalPortPropertiesMsg) {
	...
	err = ps6000SetTriggerDigitalPortProperties(m.Handle(), tdp)
...
func setSigGenBuiltIn(m *genericps.SetSigGenBuiltInMsg) {
	...
	err = ps6000SetSigGenBuiltIn(m.Handle(), m.OffsetVoltage, m.PkToPK, WaveTypeEnum(m.WaveType), m.StartFrequency,
...
func setSigGenBuiltInV2(m *genericps.SetSigGenBuiltInV2Msg) {
	...
	err = ps6000SetSigGenBuiltInV2(m.Handle(), m.OffsetVoltage, m.PkToPK, WaveTypeEnum(m.WaveType), m.StartFrequency,
		m.StopFrequency, m.Increment, m.DwellTime, SweepTypeEnum(m.SweepType),
		ExtraOperations(m.Operation), m.Shots, m.Sweeps, SigGenTrigType(m.TriggerType),
		SigGenTrigSource(m.TriggerSource), m.ExtInThreshold)
...
func sigGenFrequencyToPhase(m *genericps.SigGenFrequencyToPhasenMsg) {
	...
	phase, err = ps6000SigGenFrequencyToPhase(m.Handle(), m.Frequency, IndexMode(m.IndexMode), m.BufferLength)
...
func setNumOfCaptures(m *genericps.SetNumOfCapturesMsg) {
	err := ps6000SetNoCaptures(m.Handle(), m.NCaptures)
...
func getTriggerTimeOffset(m *genericps.GetTriggerTimeOffsetMsg) {
	...
	timeUpper, timeLower, timeUnits, err = ps6000GetTriggerTimeOffset(m.Handle(),
		uint32(m.SegmentIndex))
...
func getTriggerTimeOffset64(m *genericps.GetTriggerTimeOffset64Msg) {
	time, timeUnits, err := ps6000GetTriggerTimeOffset64(m.Handle(), uint32(m.SegmentIndex))
...
func getValuesTriggerTimeOffsetBulk(m *genericps.GetValuesTriggerTimeOffsetBulkMsg) {
	...
	err = ps6000GetValuesTriggerTimeOffsetBulk(m.Handle(), m.TimesUpper, m.TimesLower, tu, m.FromSegmentIndex, m.ToSegmentIndex)
...
func getValuesTriggerTimeOffsetBulk64(m *genericps.GetValuesTriggerTimeOffsetBulk64Msg) {
	...
	err = ps6000GetValuesTriggerTimeOffsetBulk64(m.Handle(), m.Times, tu, m.FromSegmentIndex, m.ToSegmentIndex)
...
func holdOff(m *genericps.HoldOffMsg) {
	err := ps6000HoldOff(m.Handle(), m.HoldOff, HoldOffType(m.HoldOffType))
...
func lsReady(m *genericps.LsReadyMsg) {
	ready, err := ps6000LsReady(m.Handle())
...
func triggerOrPulseWidthQualifierEnabled(m *genericps.TriggerOrPulseWidthQualifierEnabledMsg) {
	triggerEnabled, pulseWidthQualifierEnabledint16, err := ps6000TriggerOrPulseWidthQualifierEnabled(m.Handle())
...
func numOfStreamingValues(m *genericps.NumOfStreamingValuesMsg) {
	numOfValues, err := ps6000NoOfStreamingValues(m.Handle())
...
func queryOutputEdgeDetect(m *genericps.QueryOutputEdgeDetectMsg) {
	state, err := ps6000QueryOutputEdgeDetect(m.Handle())
...
func setOutputEdgeDetect(m *genericps.SetOutputEdgeDetectMsg) {
	err := ps6000SetOutputEdgeDetect(m.Handle(), m.State)
...
func setPulseWidthDigitalPortProperties(m *genericps.SetPulseWidthDigitalPortPropertiesMsg) {
	...
	err = ps6000SetPulseWidthDigitalPortProperties(m.Handle(), dd)
...
func setSigGenArbitrary(m *genericps.SetSigGenArbitraryMsg) {
	...
	err = ps6000SetSigGenArbitrary(m.Handle(), m.OffsetVoltage, m.PkToPK, m.StartDeltaPhase,
...
func setSigGenPropertiesArbitrary(m *genericps.SetSigGenPropertiesArbitraryMsg) {
	err := ps6000SetSigGenPropertiesArbitrary(m.Handle(), m.OffsetVoltage, m.StartDeltaPhase,
...
func setSigGenPropertiesBuiltIn(m *genericps.SetSigGenPropertiesBuiltInMsg) {
	err := ps6000SetSigGenPropertiesBuiltIn(m.Handle(), m.OffsetVoltage, float64(m.StartFrequency),
...
func sigGenArbitraryMinMaxValues(m *genericps.SigGenArbitraryMinMaxValuesMsg) {
	minArbitraryWaveformValue, maxArbitraryWaveformValue, minArbitraryWaveformSize,
		maxArbitraryWaveformSize, err := ps6000SigGenArbitraryMinMaxValues(m.Handle())
...
func sigGenSoftwareControl(m *genericps.SigGenSoftwareControlMsg) {
	err := ps6000SigGenSoftwareControl(m.Handle(), m.State)
