...
func getValues(m *genericps.GetValuesMsg) {
	...
	numOfSamples, overflow, err = ps6000aGetValues(m.Handle(), m.StartIndex,
		m.ReqNumOfSamples,
		m.DownSampleRatio,
...
func setChannel(m *genericps.SetChannelMsg) {
	var err error
	err = ps6000aSetChannel(m.Handle(), ChannelId(m.Channel),
...
func flashLed(m *genericps.FlashLedMsg) {
	err := ps6000aFlashLed(m.Handle(), m.Start)
...
func getUnitInfo(m *genericps.GetUnitInfoMsg) {
	...
	s, err = ps6000aGetUnitInfo(m.Handle(), PicoInfo(m.Info))
	if err != nil {
...
func getValuesAsync(m *genericps.GetValuesAsyncMsg) {
	var err error
	err = ps6000aGetValuesAsync(m.Handle(), m.StartIndex,
		m.NumOfSamples,
		m.DownSampleRatio,
		RatioMode(m.DownSampleRatioMode),
...
func getValuesOverlapped(m *genericps.GetValuesOverlappedMsg) {
	...
	numOfSamples, err = ps6000aGetValuesOverlapped(m.Handle(), m.StartIndex, m.ReqNumOfSamples,
...
func getValuesOverlappedBulk(m *genericps.GetValuesOverlappedBulkMsg) {
	...
	numOfSamples, err = ps6000aGetValuesOverlappedBulk(m.Handle(), m.StartIndex, m.ReqNumOfSamples,
...
func getAnalogueOffsetMsg(m *genericps.GetAnalogueOffsetMsg) {
	...
	maximumVoltage, minimumVoltage, err = ps6000aGetAnalogueOffset(m.Handle(), m.VoltageRange, Coupling(m.Coupling))
...
func getChannelInformation(m *genericps.GetChannelInformationMsg) {
	...
	lengthOfRanges, err = ps6000aGetChannelInformation(m.Handle(), m.Info, m.Probe, m.Ranges, ChannelId(m.Channel))
...
func getMaxDownSampleRatio(m *genericps.GetMaxDownSampleRatioMsg) {
	...
	maxDownSampleRatio, err = ps6000aGetMaxDownSampleRatio(m.Handle(), m.NumOfUnaggregatedSamples, RatioMode(m.DownSampleRatioMode), m.SegmentIndex)
...
func getMaxSegments(m *genericps.GetMaxSegmentsMsg) {
	maxSegments, err := ps6000aGetMaxSegments(m.Handle())
...
func getNumberOfCaptures(m *genericps.GetNumOfCapturesMsg) {
	numOfCaptures, err := ps6000aGetNumOfCaptures(m.Handle())
...
func getNumberOfProcessedCaptures(m *genericps.GetNumOfProcessedCapturesMsg) {
	numOfCaptures, err := ps6000aGetNumOfProcessedCaptures(m.Handle())
...
func getStreamingLatestValues(m *genericps.GetStreamingLatestValuesMsg) {
	...
	err = ps6000aGetStreamingLatestValues(m.Handle(), StreamingReady(m.LpStreamingReadyGoPar), m.Param)
...
func maximumValue(m *genericps.MaximumValueMsg) {
	value, err := ps6000aMaximumValue(m.Handle())
...
func minimumValue(m *genericps.MinimumValueMsg) {
	value, err := ps6000aMinimumValue(m.Handle())
...
func setSimpleTrigger(m *genericps.SetSimpleTriggerMsg) {
	...
	err = ps6000aSetSimpleTrigger(m.Handle(), m.Enable, ChannelId(m.Source),
...
func setDataBuffers(m *genericps.SetDataBuffersMsg) {
	...
	err = ps6000aSetDataBuffers(m.Handle(), ChannelId(m.Ch), m.BufferMax, m.BufferMin, m.SegmentIndex, RatioMode(m.Mode))
...
func setUnscaledDataBuffers(m *genericps.SetUnscaledDataBuffersMsg) {
	...
	err = ps6000aSetUnscaledDataBuffers(m.Handle(), ChannelId(m.Ch), m.BufferMax, m.BufferMin, m.SegmentIndex, RatioMode(m.Mode))
...
func setEtsTimeBuffer(m *genericps.SetEtsTimeBufferMsg) {
	err := ps6000aSetEtsTimeBuffer(m.Handle(), m.Buffer)
...
func setEtsTimeBuffers(m *genericps.SetEtsTimeBuffersMsg) {
	err := ps6000aSetEtsTimeBuffers(m.Handle(), m.TimeUpper, m.TimeLower)
	response := m.Rsp().(*genericps.SetEtsTimeBufferRsp)
	response.SetStatus(err)
	m.RspCh() <- struct{}{}
}
func setEts(m *genericps.SetEtsMsg) {
	...
	sampleTimePicoseconds, err = ps6000aSetEts(m.Handle(), EtsMode(m.Mode), m.EtsCycles, m.EtsInterleave)
...
func runStreaming(m *genericps.RunStreamingMsg) {
	...
	sampleInterval, err = ps6000aRunStreaming(m.Handle(), m.ReqSampleInterval, TimeUnits(m.SampleIntervalTimeUnits), m.MaxPostTriggerSamples,
...
func runBlock(m *genericps.RunBlockMsg) {
	...
	timeIndisposedMs, err = ps6000aRunBlock(m.Handle(), m.NumOfPreTriggerSamples, m.NumOfPostTriggerSamples,
...
func setTriggerChannelConditions(m *genericps.SetTriggerChannelConditionsMsg) {
	...
	err = ps6000aSetTriggerChannelConditions(m.Handle(), tc)
...
func setTriggerChannelDirections(m *genericps.SetTriggerChannelDirectionsMsg) {
	...
	err = ps6000aSetTriggerChannelDirections(m.Handle(), ThresholdDirection(m.ChannelA),
...
func setTriggerDelay(m *genericps.SetTriggerDelayMsg) {
	err := ps6000aSetTriggerDelay(m.Handle(), uint64(m.Delay))
...
func setTriggerDigitalPortProperties(m *genericps.SetTriggerDigitalPortPropertiesMsg) {
	...
	err = ps6000aSetTriggerDigitalPortProperties(m.Handle(), DigitalPort(m.Port), tdp)
...
func setSigGenBuiltIn(m *genericps.SetSigGenBuiltInMsg) {
	...
	err = ps6000aSetSigGenBuiltIn(m.Handle(), m.OffsetVoltage, m.PkToPK, WaveTypeEnum(m.WaveType), m.StartFrequency,
...
func setSigGenBuiltInV2(m *genericps.SetSigGenBuiltInV2Msg) {
	...
	err = ps6000aSetSigGenBuiltInV2(m.Handle(), m.OffsetVoltage, m.PkToPK, WaveTypeEnum(m.WaveType), m.StartFrequency,
		m.StopFrequency, m.Increment, m.DwellTime, SweepTypeEnum(m.SweepType),
		ExtraOperations(m.Operation), m.Shots, m.Sweeps, SigGenTrigType(m.TriggerType),
		SigGenTrigSource(m.TriggerSource), m.ExtInThreshold)
...
func sigGenFrequencyToPhase(m *genericps.SigGenFrequencyToPhasenMsg) {
	...
	phase, err = ps6000aSigGenFrequencyToPhase(m.Handle(), m.Frequency, IndexMode(m.IndexMode), m.BufferLength)
...
func setNumOfCaptures(m *genericps.SetNumOfCapturesMsg) {
	err := ps6000aSetNoCaptures(m.Handle(), m.NCaptures)
...
func getTriggerTimeOffset(m *genericps.GetTriggerTimeOffsetMsg) {
	...
	timeUpper, timeLower, timeUnits, err = ps6000aGetTriggerTimeOffset(m.Handle(), m.SegmentIndex)
...
func getTriggerTimeOffset64(m *genericps.GetTriggerTimeOffset64Msg) {
	time, timeUnits, err := ps6000aGetTriggerTimeOffset64(m.Handle(), m.SegmentIndex)
...
func getValuesTriggerTimeOffsetBulk(m *genericps.GetValuesTriggerTimeOffsetBulk64Msg) {
	var (
		err error
	)
	...
	err = ps6000aGetValuesTriggerTimeOffsetBulk64(m.Handle(), m.Times, tu, m.FromSegmentIndex, m.ToSegmentIndex)
...
func holdOff(m *genericps.HoldOffMsg) {
	err := ps6000aHoldOff(m.Handle(), m.HoldOff, HoldOffType(m.HoldOffType))
...
func lsReady(m *genericps.LsReadyMsg) {
	ready, err := ps6000aLsReady(m.Handle())
...
func triggerOrPulseWidthQualifierEnabled(m *genericps.TriggerOrPulseWidthQualifierEnabledMsg) {
	triggerEnabled, pulseWidthQualifierEnabledint16, err := ps6000aTriggerOrPulseWidthQualifierEnabled(m.Handle())
...
func memorySegments(m *genericps.MemorySegmentsMsg) {
	nMaxSamples, err := ps6000aMemorySegments(m.Handle(), m.NSegments)
...
func numOfStreamingValues(m *genericps.NumOfStreamingValuesMsg) {
	numOfValues, err := ps6000aNoOfStreamingValues(m.Handle())
...
func queryOutputEdgeDetect(m *genericps.QueryOutputEdgeDetectMsg) {
	state, err := ps6000aQueryOutputEdgeDetect(m.Handle())
...
func setDigitalPort(m *genericps.SetDigitalPortMsg) {
	...
	err = ps6000aSetDigitalPort(m.Handle(), DigitalPort(m.Port), m.Enabled, m.Logiclevel)
	response := m.Rsp().(*genericps.SetDigitalAnalogTriggerOperandRsp)
	response.SetStatus(err)
	m.RspCh() <- struct{}{}
}
...
func setOutputEdgeDetect(m *genericps.SetOutputEdgeDetectMsg) {
	err := ps6000aSetOutputEdgeDetect(m.Handle(), m.State)
...
func setSigGenArbitrary(m *genericps.SetSigGenArbitraryMsg) {
	...
	err = ps6000aSetSigGenArbitrary(m.Handle(), m.OffsetVoltage, m.PkToPK, m.StartDeltaPhase,
...
func setSigGenPropertiesArbitrary(m *genericps.SetSigGenPropertiesArbitraryMsg) {
	err := ps6000aSetSigGenPropertiesArbitrary(m.Handle(), m.OffsetVoltage, m.StartDeltaPhase,
...
func setSigGenPropertiesBuiltIn(m *genericps.SetSigGenPropertiesBuiltInMsg) {
	err := ps6000aSetSigGenPropertiesBuiltIn(m.Handle(), m.OffsetVoltage, float64(m.StartFrequency),
...
func sigGenArbitraryMinMaxValues(m *genericps.SigGenArbitraryMinMaxValuesMsg) {
	minArbitraryWaveformValue, maxArbitraryWaveformValue, minArbitraryWaveformSize,
		maxArbitraryWaveformSize, err := ps6000aSigGenArbitraryMinMaxValues(m.Handle())
...
func sigGenSoftwareControl(m *genericps.SigGenSoftwareControlMsg) {
	err := ps6000aSigGenSoftwareControl(m.Handle(), m.State)
