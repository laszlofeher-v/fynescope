...
func loadConstants() {
	...
	genericps.Range_10mv = genericps.RangeEnum(X1Probe10mv)
	genericps.Range_20mv = genericps.RangeEnum(X1Probe20mv)
	genericps.Range_50mv = genericps.RangeEnum(X1Probe50mv)
	genericps.Range_100mv = genericps.RangeEnum(X1Probe100mv)
	genericps.Range_200mv = genericps.RangeEnum(X1Probe200mv)
	genericps.Range_500mv = genericps.RangeEnum(X1Probe500mv)
	genericps.Range_1v = genericps.RangeEnum(X1Probe1v)
	genericps.Range_2v = genericps.RangeEnum(X1Probe2v)
	genericps.Range_5v = genericps.RangeEnum(X1Probe5v)
	genericps.Range_10v = genericps.RangeEnum(X1Probe10v)
	genericps.Range_20v = genericps.RangeEnum(X1Probe20v)
	genericps.Range_50v = genericps.RangeEnum(X1Probe50v)
