...
func getValues(m *genericps.GetValuesMsg) {
	...
	numOfSamples, overflow, err = ps4000GetValues(m.Handle(), uint32(m.StartIndex),
...
func getValuesAsync(m *genericps.GetValuesAsyncMsg) {
	var err error
	err = ps4000GetValuesAsync(m.Handle(), uint32(m.StartIndex),
...
func getValuesBulk(m *genericps.GetValuesBulkMsg) {
	...
	numOfSamples, err = ps4000GetValuesBulk(m.Handle(),
		uint32(m.ReqNumOfSamples), uint32(m.FromSegmentIndex),
...
func getTimebase(m *genericps.GetTimebaseMsg) {
	timeIntervalNanoseconds, maxSamples, err := ps4000GetTimebase(m.Handle(),
...
func getTimebase2(m *genericps.GetTimebase2Msg) {
	timeIntervalNanoseconds, maxSamples, err := ps4000GetTimebase2(m.Handle(),
...
func setDataBuffer(m *genericps.SetDataBufferMsg) {
	...
	err = ps4000SetDataBuffer(m.Handle(), ChannelId(m.Ch), m.BufferIn,
...
func runBlock(m *genericps.RunBlockMsg) {
	...
	timeIndisposedMs, err = ps4000RunBlock(m.Handle(),
...
func getTriggerTimeOffset(m *genericps.GetTriggerTimeOffsetMsg) {
	...
	timeUpper, timeLower, timeUnits, err = ps4000GetTriggerTimeOffset(m.Handle(),
		uint32(m.SegmentIndex))
...
func getTriggerTimeOffset64(m *genericps.GetTriggerTimeOffset64Msg) {
	time, timeUnits, err := ps4000GetTriggerTimeOffset64(m.Handle(),
		uint32(m.SegmentIndex))
...
func memorySegments(m *genericps.MemorySegmentsMsg) {
	nMaxSamples, err := ps4000MemorySegments(m.Handle(), int16(m.NSegments))
